...
收藏的他人 skills。只记录 GitHub 地址与一句话简介，不复制源码进本仓库（避免膨胀与上游失同步）。安装时以各仓库 README 为准。

| # | Skill | 仓库 | 简介 |
|---|-------|------|------|
| 1 | ARIS / Auto-Research-In-Sleep | https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep | 轻量 Markdown-only skills，用于自主 ML 研究：跨模型 review 循环、idea 发现、实验自动化，无框架依赖 |
